...
const SECTIONS = {
  ...
  sponsorships: { label: 'Your Deal Flow 💼', icon: SponsorshipIcon, component: Sponsorships },
  affiliates: { label: 'Passive Income 💸', icon: AffiliateIcon, component: Affiliates },
  leads: { label: 'Lead Gen 👥', icon: LeadIcon, component: Leads },
  pricing: { label: 'Smart Pricing 💰', icon: PricingIcon, component: Pricing },
  products: { label: 'Products 🌙', icon: ProductsIcon, component: Products },
  brand: { label: 'Brand Kit 🎨', icon: BrandIcon, component: BrandBuilder },
  inbox: { label: 'Inbox 📬', icon: InboxIcon, component: Inbox },
  opportunities: { label: 'Deal Finder 🔍', icon: OpportunitiesIcon, component: OpportunityFeed },
