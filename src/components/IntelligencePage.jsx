  ...
  return (
    <div className="page-enter space-y-10 pb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/15 rounded-full -translate-y-1/2 translate-x-1/4 blur-2xl" />
          <div className="relative">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-xl bg-emerald-600/25 flex items-center justify-center">
            ...
            <div className="flex items-center gap-1.5 mt-3">
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-[11px] font-medium text-emerald-400">
        ...
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-violet-500/15 rounded-full -translate-y-1/2 translate-x-1/4 blur-2xl" />
          <div className="relative">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-xl bg-violet-600/25 flex items-center justify-center">
        ...
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/15 rounded-full -translate-y-1/2 translate-x-1/4 blur-2xl" />
          <div className="relative">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-xl bg-amber-600/25 flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/15 rounded-full -translate-y-1/2 translate-x-1/4 blur-2xl" />
          <div className="relative">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-xl bg-blue-600/25 flex items-center justify-center">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 flex-wrap mb-2">
                ...
                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-xs font-semibold text-emerald-400">
            ...
            <button
              ...
              className="shrink-0 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-500/20 text-emerald-400 text-sm font-semibold hover:bg-emerald-500/30 transition-all border border-emerald-500/20"
            >
              View Details
...
function QuickStatCard({ icon, label, value, color, active, pulse }) {
  const colorMap = {
    emerald: { text: 'text-emerald-400', bg: 'bg-emerald-500/20', border: 'border-emerald-500/30', glow: 'shadow-emerald-500/20' },
    amber: { text: 'text-amber-400', bg: 'bg-amber-500/20', border: 'border-amber-500/30', glow: 'shadow-amber-500/20' },
    rose: { text: 'text-rose-400', bg: 'bg-rose-500/20', border: 'border-rose-500/30', glow: 'shadow-rose-500/20' },
    accent: { text: 'text-accent-400', bg: 'bg-accent-500/20', border: 'border-accent-500/30', glow: 'shadow-accent-500/20' },
  }
